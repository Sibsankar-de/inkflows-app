...
export const ProfileSettings = () => {
    ...
    useEffect(() => {
        ...
        const checkUserValidity = async () => {
            const isValidate = validateUsername(userInput?.userName)
            setIsUserValidate(isValidate)
        }
        ...
        <>
            <div>
                ...
                <div className='if-settings-body-container'>
                    ...
                    {!isUserAvailable && <p className='text-danger if-font-s'><span><i class="ri-information-2-line"></i> </span><span>User name already taken</span></p>}
                    {!isUserValidate && <p className='text-danger if-font-s'><span><i class="ri-information-2-line"></i> </span><span>User name is not valid.</span> <a href="" className='if-url-coloured'>Learn more</a></p>}
    ...
    return (
        <div>
            ...
            <div>
                                ...
                                <div>
                                    ...
                                    <div className='if-font-s if-col-fade'>
                                        {canChangePassword===false ? <span className='text-danger'>
                                            <i class="ri-information-2-line"></i> You are authenticated using google. So you cannot change password.
                                        </span> :
                                            <span>
                ...
                <div>
                    <div className='mb-2'>
                        <a href="" className='if-url-coloured'><span><i className="ri-article-line"></i></span> <span>Privacy Policy</span></a>
                    </div>
                    <div>
                        <a href="" className='if-url-coloured'><span><i className="ri-article-line"></i></span> <span>Terms and conditions</span></a>
                    </div>
                </div>
                <div className='mt-5'>
